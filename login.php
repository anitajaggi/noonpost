...
<!-- Mirrored from assiagroupe.tech/noonpost/html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jun 2024 12:48:56 GMT -->
                    ...
                    <div class="col-lg-6 m-auto">
                        <div class="widget">
                            ...
                            <form action="#" class="widget__form" method="post">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control widget__form-input" placeholder="Password*" name="password" value="" required="required">
                                </div>
                                <div class="widget__form-controls form-group">
                                    <div class="widget__form-controls-checkbox">
                                        <input type="checkbox" class="widget__form-controls-input" id="rememberMe" required="required">
            ...
            <div class="row">
                <div class="col-lg-6 m-auto col-md-8 col-sm-11">
                    <div class="search__content ">
                        ...
                        <form class="search__form" action="https://assiagroupe.tech/noonpost/html/search-page.html">
