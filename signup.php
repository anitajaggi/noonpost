...
<!-- Mirrored from assiagroupe.tech/noonpost/html/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Jun 2024 12:48:56 GMT -->
<head>
    <!-- Meta -->
    <meta charset="UTF-8">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu ">
                                    <li><a class="dropdown-item active" href="author.html">author </a></li>
                                    <li><a class="dropdown-item" href="about.html">about us </a> </li>
                                    <li><a class="dropdown-item" href="contact.html">contact us</a></li>
                                    <li><a class="dropdown-item" href="login.html">login</a></li>
                                    <li><a class="dropdown-item active" href="signup.html">Sign up</a></li>
